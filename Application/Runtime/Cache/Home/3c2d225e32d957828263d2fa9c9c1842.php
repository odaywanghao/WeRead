...
<FORM method="post" action="/weread/index.php/Home/Comments/logout">
...
<?php if($userDianzan == 1): ?><h1>点赞</h1>
	<FORM method="post" action="/weread/index.php/Home/Comments/dianzan/dian/1">
	<INPUT type="submit" value="点赞">
	</FORM>
<?php else: ?>
	<FORM method="post" action="/weread/index.php/Home/Comments/dianzan">
	<INPUT type="submit" value="点赞">
	</FORM><?php endif; ?>
 ...
 <h1>add comment</h1>
<FORM method="post" action="/weread/index.php/Home/Comments/addComment">
